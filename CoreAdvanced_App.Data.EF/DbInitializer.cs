...
namespace CoreAdvanced_App.Data.EF
{
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            if (_context.Footers.Count(x => x.Id == SystemConstants.DefaultFooterId) == 0)
            {
                string content = "Footer";
                _context.Footers.Add(new Footer()
                {
                    Id = SystemConstants.DefaultFooterId,
                    Content = content
                });
            ...
            if (!_context.SystemConfigs.Any(x => x.Id == 1))
            {
            ...
            if (!_context.SystemConfigs.Any(x => x.Id == 2))
            {
                _context.SystemConfigs.Add(new SystemConfig()
                {
                    Id = 2,
            ...
            if (!_context.SystemConfigs.Any(x => x.Id == 3))
            {
                _context.SystemConfigs.Add(new SystemConfig()
                {
                    Id = 3,
